...
// liveViewers: Map<token, Array<{viewerName, at}>> — who is watching each of my
// live links right now (Hearth 05a "Watching now").
export const liveViewers = writable(new Map());
