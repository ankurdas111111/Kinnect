...
<style>
  ...
  /* A low score "needs a look" — deep ochre, never the SOS vermilion */
  .pill-green { background: color-mix(in oklch, var(--success-500) 14%, transparent); color: var(--success-700); border: 1px solid color-mix(in oklch, var(--success-500) 28%, transparent); }
  .pill-amber { background: color-mix(in oklch, var(--warning-500) 12%, transparent); color: var(--warning-700); border: 1px solid color-mix(in oklch, var(--warning-500) 26%, transparent); }
  .pill-red   { background: color-mix(in oklch, var(--warning-500) 16%, transparent); color: var(--warning-700); border: 1px solid color-mix(in oklch, var(--warning-700) 30%, transparent); }
